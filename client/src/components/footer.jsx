      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h5 className="text-lg font-bold text-gray-800">Farmify</h5>
            <p className="text-gray-600 text-sm leading-relaxed">
              Your go-to platform for crop recommendations, tailored to your
          ...
          {/* Products */}
          <div className="space-y-4">
            <h5 className="text-lg font-bold text-gray-800">Products</h5>
          ...
          {/* Useful Links */}
          <div className="space-y-4">
            <h5 className="text-lg font-bold text-gray-800">Useful Links</h5>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h5 className="text-lg font-bold text-gray-800">Contact</h5>
            <address className="not-italic text-gray-600 text-sm space-y-2">
              <div className="flex items-start">
                ...
                <span>123 Farm Road, Agri City, FC 12345</span>
              </div>
              <div className="flex items-start">
                <svg
                  className="w-4 h-4 mt-0.5 mr-2 text-green-600"
        ...
        <div className="pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Farmify. All rights reserved.
            </p>
